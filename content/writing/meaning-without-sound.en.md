...
[YomiNote](/en/p/yominote) was built for exactly that. Drop any Japanese passage in, and every kanji has its kana floating overhead. Read along. It doesn't try to solve "learning Japanese" — a vast problem. It only solves the narrow gap between "I can read this" and "I can pronounce this."

...
import { ArrowLeft, CheckCircle2, Cpu, ArrowRight, Download, Apple, Puzzle, ExternalLink, Smartphone } from 'lucide-react';
...
import YomiCommunitySection from './YomiCommunitySection';
...
export default async function ProductDetailPage({ params }: { params: { lang: Locale; slug: string } }) {
  ...
  return (
    <div className="min-h-screen bg-[var(--background-start-rgb)]">
      ...
      {/* Community Section - YomiPlay only, visibility controlled client-side via feature flag */}
      {product.slug === 'yomiplay' && <YomiCommunitySection lang={params.lang} />}
